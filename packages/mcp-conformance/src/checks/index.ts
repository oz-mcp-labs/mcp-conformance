...
import {
  ...
  asMetadataOriginConsistent,
  asMetadataPkceS256,
  asMetadataRfc9207Cimd,
  authorizationEndpointSameOrigin,
...
export const ALL_CHECKS: Record<CheckId, Check> = {
  ...
  'initialize-session-id-issued': initializeSessionIdIssued,
  ...
  'as-metadata-origin-consistent': asMetadataOriginConsistent,
  'authorization-endpoint-same-origin': authorizationEndpointSameOrigin,
  'as-metadata-rfc9207-cimd': asMetadataRfc9207Cimd,
  'oauth-authorization-code-flow': oauthAuthorizationCodeFlow,
